        ...
        <tbody>
          <?php foreach($results as $result): ?>
           <tr>
              ...
              <td class="desc">
                <p><?php echo remove_junk(ucfirst($result['name']));?><p>
              </td>
              ...
              <td class="text-right">Rs <?php echo remove_junk($result['total_saleing_price']);?></td>
          </tr>
        <?php endforeach; ?>
        </tbody>
        <tfoot>
...
<center>
<button onClick="window.print()">Print this page</button></center>
  <?php
    else:
