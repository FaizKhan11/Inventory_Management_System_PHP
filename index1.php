			...
			<form method="post">
				   ...
				   <div class="col-md-6">
						<div class="form-group">
							...
							<select name="barcodeType" id="barcodeType" class="form-control">
								<option value="codabar" <?php echo (@$_POST['barcodeType'] == 'codabar' ? 'selected="selected"' : ''); ?>>Codebar</option>
				...
				<div class="row">
					<div class="col-md-7">
						...
						<button><input type="submit" name="generateBarcode"  value="Generate Barcode"></button>
					</div>
				</div>
			</form>
		</div>
